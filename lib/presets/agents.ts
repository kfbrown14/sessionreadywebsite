...
export const AikoGrieving: ClientPersona = {
  ...
  description: 'Support a 22-year-old Asian-American college student navigating grief, exploring gender identity (She/They), and seeking self-acceptance.',
...
export const JordanTrauma: ClientPersona = {
  ...
  description: 'Assist Jordan, a 35-year-old non-binary parent, in working through complex trauma (C-PTSD) and navigating co-parenting.',
...
export const ZahraDepression: ClientPersona = {
  ...
  description: 'Guide Zahra, a 52-year-old Iranian-American woman, struggling with identity loss and depression after her children moved out.',
